...
#define GPIO_PinSource_CAN2_1 GPIO_PinSource12
#define GPIO_PinSource_CAN2_2 GPIO_PinSource13

#define GPIO_Pin_CAN2_1 GPIO_Pin_12
#define GPIO_Pin_CAN2_2 GPIO_Pin_13
/*
*@Description：CAN1初始化
*@param 1：	  参数1
*@param 2：	  参数2

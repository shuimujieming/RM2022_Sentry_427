...
void Gimbal_Init()
{
	...
	//150 0 0
		...
		Pid_Set(&PID_Gimbal_Speed[1],250,0,0,30000,5000,30000,30000,1,30000,0,2); //Pitch
		PID_Gimbal_Speed[1].PIDOutCompensate = 7300;
	//5 0 0 
	// 250 0 0
	
		//2034
		Pid_Set(&PID_Gimbal_Angle[0],35,0,0,10000,3000,30000,10000,1,30000,0,2);	//Yaw
		Pid_Set(&PID_Gimbal_Speed[0],100,0,0,30000,5000,200,30000,1,30000,0,2); //Yaw

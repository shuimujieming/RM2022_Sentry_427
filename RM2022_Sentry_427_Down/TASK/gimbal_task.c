...
float Pitch_Aim_Angle = 4210;
float Pitch_Angle_Max = 4450;
float Pitch_Angle_Min = 3580;
...
void Gimbal_Follow_Control()
{
		...
		CAN_Gimbal[0].Target_Current = -Pid_Calc(&PID_Gimbal_Speed[0],mpu_data.gy * 0.1f,PID_Gimbal_Angle[0].PIDout);
}

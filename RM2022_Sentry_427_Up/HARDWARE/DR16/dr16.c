#include "dr16.h"
#define RCC_AHBPeriphClockCmd_GPIO_DR16 RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB,ENABLE)
#define RCC_APBPeriphClockCmd_USART_DR16 RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1,ENABLE)
#define GPIO_AF_USART_DR16 GPIO_AF_USART1

#define GPIO_DR16 GPIOB
#define GPIO_PinSource_DR16 GPIO_PinSource7
#define GPIO_Pin_DR16 GPIO_Pin_7
#define USART_DR16 USART1
#define USART_NUC_IRQn USART1_IRQn

#define RCC_AHBPeriphClockCmd_DMA_DR16 	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_DMA2, ENABLE)
#define DMA_Stream_DR16 DMA2_Stream2
#define DMA_Channel_DR16 DMA_Channel_4
#define USART_DR16_IRQHandler USART1_IRQHandler

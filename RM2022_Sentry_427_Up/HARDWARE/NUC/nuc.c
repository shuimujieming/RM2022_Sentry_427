#include "nuc.h"
#define RCC_AHBPeriphClockCmd_GPIO_NUC RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOG,ENABLE)
#define RCC_APBPeriphClockCmd_USART_NUC RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART6, ENABLE)

#define GPIO_NUC GPIOG
#define GPIO_PinSource_NUC_1 GPIO_PinSource9
#define GPIO_PinSource_NUC_2 GPIO_PinSource14

#define GPIO_AF_USART_NUC GPIO_AF_USART6
#define GPIO_Pin_NUC_1 GPIO_Pin_9
#define GPIO_Pin_NUC_2 GPIO_Pin_14
#define USART_NUC USART6

#define DMA_Channel_NUC_RX DMA_Channel_5
#define DMA_Stream_NUC_RX DMA2_Stream1

#define DMA_Channel_NUC_TX DMA_Channel_5
#define DMA_Stream_NUC_TX DMA2_Stream7

#define DMA_Stream_NUC_IRQn DMA2_Stream7_IRQn
#define DMA_Stream_NUC_TX_IRQHandler DMA2_Stream7_IRQHandler
#define DMA_IT_TCIF_NUC DMA_IT_TCIF7


#define USART_NUC_IRQn USART6_IRQn
#define USART_NUC_IRQHandler USART6_IRQHandler

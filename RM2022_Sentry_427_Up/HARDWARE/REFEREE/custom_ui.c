...
//	}
	...
	Referee_Data_Send(0x0301,(uint8_t *)&character_one);
	Referee_Data_Send(0x0301,(uint8_t *)&character_two);
	Referee_Data_Send(0x0301,(uint8_t *)&character_three);
	Referee_Data_Send(0x0301,(uint8_t *)&character_four);
	Referee_Data_Send(0x0301,(uint8_t *)&character_five);
	Referee_Data_Send(0x0301,(uint8_t *)&character_six);
...
//	{sprintf(char_one,"Super Cap %.2f ON",Supper_Cup_Remain_Voltage);}
//	
//	else if(chassis_speed_mode != CHASSIS_SUPER_SPEED_MODE)
//	{sprintf(char_one,"Super Cap %.2f OFF",Supper_Cup_Remain_Voltage);}

//	if(Supper_Cup_Remain_Voltage < 19.0)
...
//	{sprintf(char_two,"Gimbal Mode is Rotate %d",Rotate_Flag);}

//	Draw_Char(&character_two,"100",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_two,12,1,80,800);
//	 
//	if(LIMIT_STA == 0)//限位触碰
//	{
//	sprintf(char_three,"Shoot Limit OK");
//	Draw_Char(&character_three,"101",Graphic_Operate_CHANGE,9,Graphic_Color_Green,char_three,12,1,80,820);
//	}
//	else
//	{
//	sprintf(char_three,"Shoot Limit No");
//	Draw_Char(&character_three,"101",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_three,12,1,80,820);		
//	}
//	
//	sprintf(char_four,"Pitch %.2f",Send_P_NUC / 100.0f );
//	Draw_Char(&character_four,"102",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_four,12,1,80,840);		
//	
//	if(shoot_mode == SHOOT_OPEN_MODE)//摩擦轮开启模式下
//	{
//	sprintf(char_five,"Fric status on   ");
//	if(abs(Shoot_Motor_201.Real_Speed) < 10)//摩擦轮堵住了
//	{
...
//	}
//	else if(shoot_mode == SHOOT_CLOSE_MODE)//摩擦轮关闭
//	{
//	sprintf(char_five,"Fric status off  ");
//	Draw_Char(&character_five,"103",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_five,12,1,80,860);						
//	}
//	//自瞄模式显示
//	if(NUC_Mode == ROBOT_MODE)
//	{
//		sprintf(char_six,"Aim Mode Robot");
//		Draw_Char(&character_six,"104",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_six,12,1,80,880);		
//	}
//	else if(NUC_Mode == ARCHITECH_MODE)
//	{
//		sprintf(char_six,"Aim Mode Arch");
//		Draw_Char(&character_six,"104",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_six,12,1,80,880);		
//	}
//	else if(NUC_Mode == SENTRY_MODE)
//	{
//		sprintf(char_six,"Aim Mode Sentry");
//		Draw_Char(&character_six,"104",Graphic_Operate_CHANGE,9,Graphic_Color_Yellow,char_six,12,1,80,880);		
//	}
//	
